...
>
    ...
    <div className="text-center">
        ...
        <p className="text-lg text-gray-700 mt-2">Some of my best projects that showcase my skills.</p>
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-10">
        {[1, 2, 3, 4, 5, 6].map((num) => (
            <div key={num} className="bg-white rounded-lg shadow-lg overflow-hidden">
                {/* Image */}
                <img src={`/Gambar${num}.png`} alt={`Project ${num}`} className="w-full h-48 object-cover" />
                
                {/* Content */}
                <div className="p-5">
                    <span className="text-sm text-gray-500 uppercase">UI-UX Design</span>
                    <h3 className="text-xl font-bold text-gray-900 mt-2">Product Admin Dashboard</h3>
...
<section className="bg-gray-900 text-white py-16 text-center px-6 md:px-20 lg:px-40">
    ...
    <p className="text-gray-400 mt-2">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration.</p>
    <button className="mt-6 bg-purple-600 text-white px-6 py-2 rounded-md">Let's work together</button>
</section>
